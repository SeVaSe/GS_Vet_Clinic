...
__all__ = [
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRGetFormat', 'SGLexical',
    'SPWT_PRONUNCIATION', 'SPRST_ACTIVE', 'SPSHT_OTHER',
    'DISPID_SRSAudioStatus', 'DISPID_SPIProperties',
    'SAFT32kHz8BitMono', 'DISPID_SPPId', 'DISPID_SGRsCount',
    'SpeechAudioState', 'ISpeechAudio', 'DISPID_SLWsItem',
    'DISPID_SpeechLexiconWords', 'SPEI_VOICE_CHANGE',
    'IEnumSpObjectTokens', 'SP_VISEME_18', 'DISPID_SGRsCommitAndSave',
    'SPSHT_EMAIL', 'DISPID_SPEEngineConfidence', 'SSFMOpenReadWrite',
    'DISPID_SPPChildren', 'DISPID_SpeechXMLRecoResult',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpStreamFormatConverter',
    'DISPID_SPRulesCount', 'DISPID_SRCEAudioLevel',
    'DISPID_SRGDictationUnload', 'SDKLCurrentUser', 'SDTAudio',
    'DISPID_SPRulesItem', 'SDTAll', 'DISPID_SRAudioInput',
    'DISPID_SOTIsUISupported', 'SECFDefault', 'ISpeechPhraseRules',
    'SPWORDTYPE', 'DISPID_SPCPhoneToId', 'SPWORDPRONOUNCEABLE',
    'SDA_One_Trailing_Space', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPILanguageId', 'SPEI_RECO_OTHER_CONTEXT', 'SINoise',
    'SAFT12kHz8BitStereo', 'SVSFNLPMask', 'DISPID_SRRTStreamTime',
    'DISPID_SBSSeek', 'DISPID_SRCEHypothesis', 'DISPIDSPRG',
    'SPPARTOFSPEECH', 'SPEI_UNDEFINED', 'ISpObjectTokenCategory',
    'SVEVoiceChange', 'SGSDisabled', 'SGRSTTDictation',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SAFType',
    'DISPID_SVAudioOutputStream', 'ISpeechLexicon',
    'SPEVENTSOURCEINFO', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechRecoContext', 'SpSharedRecognizer',
    'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRSTsItem',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVEPhoneme',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRGCmdLoadFromObject',
    'SPWORD', 'ISpMMSysAudio', 'SpeechPropertyResourceUsage',
    'SpeechDictationTopicSpelling', 'SRAInterpreter', 'SVP_11',
    'SpeechEngineProperties',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpeechDataKeyLocation', 'SVSFVoiceMask', 'SpeechTokenContext',
    'SpeechRecoContextState', 'SpeechVoiceSpeakFlags',
    'DISPID_SLRemovePronunciation', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseReplacements', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPPNumberOfElements', 'UINT_PTR', 'SpeechUserTraining',
    'SGDSActiveWithAutoPause', 'DISPID_SPEActualConfidence',
    'DISPID_SPRDisplayAttributes', 'SRSActive',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFT16kHz8BitMono',
    'SAFT44kHz16BitMono', 'DISPID_SRCESoundStart',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SREmulateRecognition',
    'SpInProcRecoContext', 'SPSEMANTICERRORINFO', 'DISPID_SVRate',
    'IInternetSecurityMgrSite', 'SAFTGSM610_22kHzMono',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpCompressedLexicon',
    'SPWT_DISPLAY', 'SPPS_RESERVED4', 'ISpeechVoiceStatus',
    'DISPID_SVSPhonemeId', 'SREPrivate', 'SVP_4', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechPhraseElements', 'DISPID_SRGCmdLoadFromMemory',
    '_ISpeechRecoContextEvents', 'ISpRecoResult', 'SRSEIsSpeaking',
    'SpeechTokenShellFolder', 'DISPID_SAStatus',
    'DISPID_SABIMinNotification', 'DISPID_SDKDeleteKey',
    'DISPID_SGRSTsCount', 'SAFTGSM610_44kHzMono',
    'DISPID_SRCEStartStream', 'DISPID_SVSVisemeId',
    'DISPID_SPAStartElementInResult', 'ISpAudio',
    'DISPID_SPIStartTime', 'SAFTCCITT_ALaw_22kHzMono', 'SVEPrivate',
    'SASClosed', 'DISPID_SPPsItem', 'SpMMAudioOut',
    'DISPID_SPEs_NewEnum', 'SpWaveFormatEx', 'DISPID_SMSAMMHandle',
    'SBOPause', 'DISPID_SAEventHandle', 'SFTSREngine',
    'SPDKL_DefaultLocation', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRCRequestedUIType', 'SpeechAudioFormatGUIDWave',
    'SRSInactive', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVSRunningState', 'DISPID_SASState', 'eLEXTYPE_PRIVATE18',
    'SPAUDIOSTATUS', 'ISpRecoContext', 'DISPID_SPPEngineConfidence',
    'SGPronounciation', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVEPhoneme', 'SpeechStreamFileMode', 'DISPID_SVVolume',
    'ISpeechDataKey', 'DISPID_SRGCmdLoadFromFile', 'ISpeechVoice',
    'SFTInput', 'SPEI_PHONEME', 'DISPID_SLWsCount', 'SPRS_ACTIVE',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT48kHz16BitStereo',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SPARecoResult',
    'DISPID_SGRSTText', 'SpeechGrammarWordType',
    'eLEXTYPE_RESERVED10', 'SREPhraseStart', 'DISPID_SOTDisplayUI',
    'SAFTADPCM_22kHzMono', 'SRSActiveAlways', 'STSF_FlagCreate',
    'SPPS_Verb', 'DISPID_SpeechWaveFormatEx', 'SpAudioFormat',
    'SAFT24kHz16BitStereo', 'DISPID_SRDisplayUI',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPPValue', 'ISpeechAudioStatus',
    'SPRST_ACTIVE_ALWAYS', 'SGDSActiveUserDelimited',
    'ISpeechTextSelectionInformation', 'DISPID_SAVolume',
    'DISPID_SRIsUISupported', 'SPFM_CREATE_ALWAYS',
    'SpPhoneConverter', 'DISPID_SRCEAdaptation',
    'DISPID_SVEAudioLevel', 'DISPID_SGRSTransitions', 'SP_VISEME_7',
    'SpeechBookmarkOptions', 'SDA_No_Trailing_Space',
    'SWPUnknownWordUnpronounceable', 'SPRULE',
    'SpeechRecoProfileProperties', 'SPEI_RESERVED1',
    'DISPID_SPEAudioStreamOffset', 'SpeechRunState',
    'ISpeechGrammarRules', 'SPWAVEFORMATTYPE',
    'SpeechSpecialTransitionType',
    'DISPID_SpeechLexiconPronunciation', 'SAFT8kHz8BitMono',
    'SpeechAudioVolume', 'SPEI_END_SR_STREAM', 'DISPID_SVGetVoices',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechGrammarRule', 'SPEI_HYPOTHESIS',
    'DISPID_SPPs_NewEnum', 'SAFTCCITT_uLaw_44kHzMono', 'SGRSTTWord',
    'SVSFPersistXML', 'eLEXTYPE_USER', 'SPEI_MAX_TTS', 'SVP_12',
    'SpStream', 'SRTEmulated', 'DISPID_SGRAddState',
    'SpeechFormatType', 'SRAONone', 'DISPID_SVEEnginePrivate',
    'SpeechEmulationCompareFlags', 'SVPNormal', 'SPPS_Noun',
    'ISpeechRecoContext', 'eLEXTYPE_PRIVATE8', 'SPSFunction',
    'SPAR_High', 'SECNormalConfidence', 'SpeechGrammarState',
    'DISPID_SVSInputSentenceLength', 'ISpXMLRecoResult',
    'DISPID_SRRSetTextFeedback', 'ISpeechRecognizerStatus',
    'DISPID_SRCEEnginePrivate', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SDKEnumValues', 'ISpeechPhraseReplacements',
    'DISPID_SVSpeakStream', 'DISPID_SRSetPropertyNumber',
    'ISpeechPhraseRule', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGState', 'SP_VISEME_21', 'SPCATEGORYTYPE',
    'SECFIgnoreWidth', 'DISPID_SRCERecognitionForOtherContext',
    'IStream', 'SRSInactiveWithPurge', 'DISPID_SGRSRule',
    'SPVPRI_OVER', 'DISPID_SBSWrite', 'ISpGrammarBuilder',
    'SPPS_RESERVED3', 'DISPID_SOTCategory', '_RemotableHandle',
    'DISPID_SLAddPronunciation', 'DISPID_SVPriority',
    'SSFMCreateForWrite', 'SREStreamStart',
    'DISPID_SOTMatchesAttributes', 'SPBO_TIME_UNITS',
    'DISPID_SPRuleName', 'STCLocalServer', 'STSF_LocalAppData',
    'DISPID_SpeechAudioStatus', 'SVSFParseMask',
    'SAFT44kHz8BitStereo', 'SpPhraseInfoBuilder', 'SPEI_ADAPTATION',
    'ISpRecoCategory', 'DISPID_SLGetPronunciations',
    'DISPID_SRCEPhraseStart', 'SAFTADPCM_44kHzStereo',
    'SpeechRuleAttributes', 'SSTTWildcard', 'DISPID_SPCIdToPhone',
    'ISpRecognizer2', 'SpeechLoadOption', 'DISPID_SpeechDataKey',
    'eLEXTYPE_VENDORLEXICON', 'SpeechCategoryVoices', 'SVSFParseSapi',
    'ISpeechMMSysAudio', 'DISPID_SGRId', 'SPSUnknown',
    'ISpeechPhraseProperties', 'SREStateChange', 'DISPID_SOTDataKey',
    'SPEI_FALSE_RECOGNITION', 'ISpeechObjectToken',
    'DISPID_SABufferNotifySize', 'SRTSMLTimeout',
    'DISPID_SDKDeleteValue', 'SDTDisplayText', 'SpeechAllElements',
    'SP_VISEME_11', 'DISPID_SLPLangId', 'SAFTGSM610_8kHzMono',
    'DISPID_SDKSetStringValue', 'DISPID_SPEsItem',
    'DISPID_SGRsDynamic', 'SPEI_SOUND_END', 'DISPID_SPCLangId',
    'SECHighConfidence', '__MIDL_IWinTypes_0009', 'SSFMOpenForRead',
    'SpeechPropertyAdaptationOn', 'SPPS_Interjection', 'SVPOver',
    'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE5',
    'SpStreamFormatConverter', 'SGDSActive',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPIEngineId', 'SpLexicon',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SGRSTWeight',
    'SPSEMANTICFORMAT', 'ISpeechRecognizer', 'SDTReplacement',
    'DISPID_SRSNumberOfActiveRules', 'SVSFIsFilename',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SLPType',
    'DISPID_SVEVoiceChange', 'DISPID_SMSALineId', 'DISPID_SVSpeak',
    'SBONone', 'SPWORDLIST', 'SpeechEngineConfidence',
    'tagSPTEXTSELECTIONINFO', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SABIEventBias', 'DISPID_SDKEnumKeys',
    'SAFTNonStandardFormat', 'DISPID_SVSCurrentStreamNumber',
    'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechPropertyHighConfidenceThreshold', 'SPGS_ENABLED',
    'SPEVENTENUM', 'eLEXTYPE_RESERVED7', 'DISPID_SRCRetainedAudio',
    'DISPID_SWFEBitsPerSample', 'SAFTDefault', 'STSF_AppData',
    'DISPID_SRRAlternates', 'SVF_Stressed',
    'DISPID_SpeechPhraseElement', 'SPAS_STOP',
    'DISPID_SDKGetBinaryValue', 'DISPID_SDKSetLongValue', 'SVP_1',
    'DISPID_SRCCreateGrammar', 'SP_VISEME_4', 'SVP_3',
    'DISPID_SPAs_NewEnum', 'ISpeechRecoResultDispatch',
    'SGLexicalNoSpecialChars', 'SPVPRI_ALERT', 'eLEXTYPE_PRIVATE13',
    'DISPID_SBSRead', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVSLastBookmark', 'DISPID_SPPParent',
    'ISpeechLexiconWords', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRCESoundEnd', 'SVP_0', 'SVP_7', 'ISpRecoGrammar',
    'DISPID_SPIAudioSizeTime', 'eLEXTYPE_RESERVED4', 'SPPS_Unknown',
    'SPPHRASEELEMENT', 'SAFT11kHz8BitStereo', 'SpeechVoiceEvents',
    'SPWT_LEXICAL', 'SpeechTokenKeyUI', 'SPCT_SUB_DICTATION',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpStream', 'SPCT_COMMAND', 'SDA_Two_Trailing_Spaces',
    'SP_VISEME_14', 'DISPID_SVGetAudioOutputs', 'SAFTADPCM_44kHzMono',
    'DISPID_SRRTTickCount', 'ISpeechLexiconWord',
    'DISPID_SPIElements', 'DISPID_SRGSetWordSequenceData',
    'SPEI_TTS_PRIVATE', 'DISPID_SFSClose', 'DISPID_SVSkip',
    'SpTextSelectionInformation', 'DISPID_SRCEPropertyNumberChange',
    'SECFEmulateResult', 'SDKLCurrentConfig',
    'SPINTERFERENCE_TOOFAST', 'SPEI_TTS_BOOKMARK',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFT12kHz16BitMono',
    'SpeechCategoryRecoProfiles', 'SPXRO_Alternates_SML',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SOTCDefault',
    'SRAImport', 'SP_VISEME_16', 'SpeechRetainedAudioOptions',
    'ISpNotifyTranslator', 'SPEI_MIN_SR', 'SPEI_SOUND_START',
    'DISPID_SPPFirstElement', 'SPEI_RESERVED2',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCERecognition',
    'SPEVENT', 'SPFM_OPEN_READONLY', 'SPSERIALIZEDRESULT',
    'DISPID_SVAlertBoundary', 'SPPS_SuppressWord', 'SVSFlagsAsync',
    'SpeechInterference', 'SRCS_Enabled', 'SRERequestUI',
    'SPAUDIOOPTIONS', 'Speech_Max_Word_Length', 'SRESoundStart',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpeechAudioBufferInfo',
    'SRESoundEnd', 'DISPID_SPEPronunciation',
    'ISpPhoneticAlphabetSelection', 'SPEI_RESERVED3',
    'SVSFPurgeBeforeSpeak', 'SVEAudioLevel', 'SpNotifyTranslator',
    'SAFT11kHz8BitMono', 'tagSTATSTG', 'eLEXTYPE_PRIVATE12',
    'DISPID_SPRuleEngineConfidence', 'SpeechVisemeFeature',
    'SAFT22kHz16BitMono', 'eWORDTYPE_DELETED',
    'SPEI_RECO_STATE_CHANGE', 'SPPS_NotOverriden',
    'DISPID_SRRAudioFormat', 'IEnumString', 'SPGRAMMARWORDTYPE',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRSTNextState',
    'ISpeechPhraseInfo', 'SAFT22kHz16BitStereo', 'SPSERIALIZEDPHRASE',
    'SASRun', 'SpObjectTokenCategory', 'SPAR_Medium',
    'SpeechVoicePriority', 'DISPID_SOTGetDescription',
    'DISPID_SpeechObjectToken', '_ISpeechVoiceEvents',
    'eLEXTYPE_PRIVATE14', 'SPEI_SR_PRIVATE', 'DISPID_SDKCreateKey',
    'SRADefaultToActive', 'SPEI_WORD_BOUNDARY',
    'SpeechCategoryAudioIn', 'DISPID_SRCVoice', 'DISPID_SPPsCount',
    'DISPID_SRAudioInputStream', 'STCInprocHandler',
    'ISpResourceManager', 'DISPID_SGRSTPropertyValue',
    'ISpeechPhraseElements', 'SVP_9',
    'DISPID_SRCAudioInInterferenceStatus', 'SPCONTEXTSTATE',
    'DISPID_SRCEPropertyStringChange', 'SPBO_NONE', 'LONG_PTR',
    'DISPID_SPEDisplayText', 'SpeechLexiconType',
    'SAFT44kHz16BitStereo', 'eLEXTYPE_RESERVED8', 'SPSMF_UPS',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechAudioFormat', 'SVEAllEvents',
    'DISPID_SRGetPropertyString', 'SPBINARYGRAMMAR',
    'DISPID_SRCRecognizer', 'DISPID_SRGCmdSetRuleState', 'SGSEnabled',
    'SPSHT_NotOverriden', 'ISpeechPhraseElement', 'SPLEXICONTYPE',
    'DISPID_SGRSAddWordTransition', 'SpeechTokenKeyAttributes',
    'ISpVoice', 'SAFT11kHz16BitMono', 'SPRST_INACTIVE_WITH_PURGE',
    'SVP_5', 'SPRS_INACTIVE', 'SGDSInactive', 'SRCS_Disabled',
    'SPAR_Low', 'DISPID_SPIRule', 'DISPID_SLWType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SLPPartOfSpeech',
    'SpeechCategoryPhoneConverters', 'eLEXTYPE_RESERVED6',
    'SPRS_ACTIVE_USER_DELIMITED', 'SREHypothesis',
    'DISPID_SPRNumberOfElements', 'SPSSuppressWord',
    'DISPID_SGRSTType', 'SPPS_LMA', 'Speech_StreamPos_RealTime',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechAudio', 'SVP_13',
    'SP_VISEME_19', 'SAFT48kHz8BitMono',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPRuleFirstElement',
    'SPINTERFERENCE_NONE', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPRuleParent', 'SAFT8kHz8BitStereo', 'SPFM_CREATE',
    'DISPID_SpeechLexiconWord', 'DISPID_SWFEFormatTag',
    'SAFTExtendedAudioFormat', 'ISpRecognizer3', 'DISPID_SLPsCount',
    'SPEI_RESERVED5', 'DISPID_SWFEAvgBytesPerSec',
    'SpResourceManager', 'DISPID_SRRTimes', 'SPPS_Modifier',
    'SPPS_RESERVED2', 'SPGRAMMARSTATE', 'DISPID_SOTCSetId',
    'SPXMLRESULTOPTIONS', 'SpeechDisplayAttributes', 'SP_VISEME_13',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SADefaultFormat',
    'DISPID_SABIBufferSize', 'DISPID_SBSFormat', 'DISPID_SVVoice',
    'DISPID_SpeechAudioBufferInfo', 'ISpeechPhraseAlternates',
    'DISPID_SpeechPhraseAlternates', 'eLEXTYPE_PRIVATE16',
    'SP_VISEME_2', 'DISPID_SOTsItem', 'SPRST_NUM_STATES',
    'SGRSTTRule', 'DISPID_SVIsUISupported', 'SP_VISEME_3',
    'SVSFIsNotXML', 'SPGS_EXCLUSIVE', 'SP_VISEME_12', 'SRATopLevel',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPAsCount',
    'DISPID_SRCEInterference', 'ISpeechLexiconPronunciation',
    'SPEI_MIN_TTS', 'DISPID_SRState', 'SVESentenceBoundary',
    'DISPID_SDKGetStringValue', 'DISPID_SRRecognizer',
    'ISpeechAudioFormat', 'DISPID_SPRuleChildren', 'ISpStreamFormat',
    'SpPhoneticAlphabetConverter', 'DISPID_SRRTOffsetFromStart',
    'DISPIDSPTSI_ActiveLength', 'SAFT24kHz16BitMono',
    'SpeechTokenValueCLSID', 'SpeechWordPronounceable',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechMMSysAudio',
    'SAFTCCITT_ALaw_11kHzStereo', 'SECLowConfidence',
    'DISPID_SPELexicalForm', 'eLEXTYPE_LETTERTOSOUND', 'SVP_15',
    'DISPID_SpeechPhraseAlternate', 'SPAS_RUN', 'eLEXTYPE_PRIVATE19',
    'SpeechRecoEvents', 'SAFT24kHz8BitMono', 'SRSEDone',
    'DISPID_SAFSetWaveFormatEx', 'SSTTDictation', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE4', 'SDKLDefaultLocation',
    'DISPID_SRRSaveToMemory', 'SLTUser', 'ISpeechGrammarRule',
    'ISpeechFileStream', 'DISPID_SGRInitialState',
    'ISpObjectWithToken', 'DISPID_SPRuleConfidence',
    'DISPID_SpeechPhraseRules', 'DISPID_SPIEnginePrivateData',
    'SPEI_SR_RETAINEDAUDIO', 'SPAS_CLOSED',
    'ISpeechPhraseReplacement', 'SVP_10', 'DISPID_SRCResume',
    'SECFNoSpecialChars', 'eLEXTYPE_PRIVATE17', 'DISPID_SpeechVoice',
    'DISPID_SRCSetAdaptationData', 'SP_VISEME_1',
    'DISPID_SPEAudioSizeBytes', 'SINone', 'SPSLMA', 'SRAORetainAudio',
    'SDA_Consume_Leading_Spaces', 'SITooFast',
    'ISpeechPhraseProperty', 'DISPID_SRRGetXMLResult', 'SPAUDIOSTATE',
    'SVEWordBoundary', 'eLEXTYPE_PRIVATE10', 'ISpPhoneConverter',
    'DISPID_SLPPhoneIds', 'SAFTCCITT_ALaw_44kHzMono', 'SGSExclusive',
    'DISPID_SLGetWords', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_REQUEST_UI', 'SPAO_RETAIN_AUDIO', 'SPRECOSTATE',
    'DISPID_SRGReset', 'SAFT24kHz8BitStereo',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechGrammarRuleState',
    'SPEI_MAX_SR', 'SP_VISEME_17', 'DISPID_SRRGetXMLErrorInfo',
    'SPPROPERTYINFO', 'SAFT32kHz8BitStereo', 'SDTAlternates',
    'SVEStartInputStream', 'DISPID_SpeechRecoResult',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SMSSetData',
    'ISpeechObjectTokenCategory', 'DISPID_SRCEBookmark',
    'SpObjectToken', 'SSSPTRelativeToEnd', 'DISPID_SPRuleId',
    'SPDKL_LocalMachine', 'DISPID_SRGIsPronounceable',
    'DISPID_SRRSpeakAudio', 'SGRSTTWildcard', 'SPEI_SR_BOOKMARK',
    'SPPS_Noncontent', 'SVSFIsXML', 'DISPID_SVGetAudioInputs',
    'DISPID_SPACommit', 'SPFM_NUM_MODES', 'ISequentialStream',
    'DISPID_SPRText', 'SVSFNLPSpeakPunc', 'DISPID_SGRs_NewEnum',
    'SpShortcut', 'SpeechRuleState', 'DISPID_SRRRecoContext',
    'SpeechDiscardType', 'DISPID_SPEsCount', 'DISPID_SWFEChannels',
    'DISPID_SpeechCustomStream', 'SPSModifier',
    'SAFT11kHz16BitStereo', 'ISpeechPhraseAlternate',
    'SpeechAudioFormatType', 'DISPID_SLPs_NewEnum',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRGetRecognizers',
    'DISPID_SPAPhraseInfo', 'SAFTNoAssignedFormat', 'SREInterference',
    'SpeechPartOfSpeech', 'DISPID_SRCEFalseRecognition',
    'SSSPTRelativeToStart', 'DISPID_SPAsItem',
    'ISpeechPhoneConverter',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPDKL_CurrentConfig',
    'DISPID_SVSInputWordPosition', 'SDTPronunciation',
    'SPEI_PHRASE_START', 'SAFTADPCM_8kHzStereo',
    'DISPID_SGRSAddSpecialTransition', 'SREBookmark',
    'DISPID_SPISaveToMemory', 'SPVPRIORITY', 'SVEBookmark',
    'SPGS_DISABLED', 'ISpeechRecoResultTimes', 'DISPID_SLWs_NewEnum',
    'SITooLoud', 'ISpPhoneticAlphabetConverter', 'SPWF_INPUT',
    'SpeechRecognizerState', 'SpeechTokenKeyFiles', 'SPSInterjection',
    'DISPID_SABufferInfo', 'DISPID_SLPSymbolic', 'SPCT_SLEEP',
    'SAFT16kHz16BitMono', 'ISpPhrase', 'DISPID_SpeechLexicon',
    'DISPID_SpeechLexiconProns', 'SVPAlert',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechWaveFormatEx',
    'ISpPhraseAlt', 'DISPID_SDKGetlongValue', 'SVF_Emphasis',
    'SPDATAKEYLOCATION', 'DISPID_SRCEventInterests', 'SPLOADOPTIONS',
    'SPINTERFERENCE_LATENCY_WARNING', 'SINoSignal', 'SVP_6',
    'DISPID_SpeechGrammarRuleStateTransition', 'tagSPPROPERTYINFO',
    'DISPID_SLPsItem', 'eLEXTYPE_PRIVATE9',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE6',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechVoiceEvent', 'SLTApp', 'SPVPRI_NORMAL',
    'DISPID_SVESentenceBoundary', 'DISPID_SOTCGetDataKey',
    'DISPID_SGRAttributes', 'SREPropertyStringChange',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPEAudioSizeTime', 'SRERecognition', 'DISPID_SASetState',
    'DISPID_SWFEBlockAlign', 'DISPID_SGRsAdd', 'SPTEXTSELECTIONINFO',
    'SAFT12kHz16BitStereo', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SLGenerationId', 'SRTAutopause',
    'DISPID_SPERequiredConfidence', 'SpUnCompressedLexicon',
    'SpeechStreamSeekPositionType', 'DISPID_SLWWord',
    'SPEI_RESERVED6', 'DISPID_SOTGetAttribute',
    'ISpeechPhraseInfoBuilder', 'SPAS_PAUSE', 'ISpeechRecoGrammar',
    'SPRULESTATE', 'WAVEFORMATEX', 'DISPID_SGRSTRule',
    'SPSHT_Unknown', 'SSFMCreate', 'DISPID_SVPause', 'DISPID_SFSOpen',
    'DISPID_SVEViseme', 'ISpeechXMLRecoResult', 'SPINTERFERENCE',
    'ISpSerializeState', 'DISPID_SVEStreamStart',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPANumberOfElementsInResult',
    'SVSFUnusedFlags', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRsItem', 'SP_VISEME_10', 'DISPID_SGRAddResource',
    'SpeechAudioFormatGUIDText', 'SREAudioLevel', 'SpeechWordType',
    'DISPID_SGRsItem', '_SPAUDIOSTATE', 'SSTTTextBuffer',
    'DISPID_SpeechRecognizer', 'DISPID_SOTsCount', 'SPPHRASERULE',
    'SVP_20', 'ISpShortcut', 'ISpeechResourceLoader',
    'DISPID_SVAudioOutput', 'DISPID_SLGetGenerationChange',
    'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVSInputSentencePosition', 'SP_VISEME_8',
    'ISpRecoGrammar2', 'SPPHRASEREPLACEMENT',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SASCurrentDevicePosition',
    'ISpeechRecoResult2', 'Speech_Max_Pron_Length',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SP_VISEME_6', 'SPVISEMES',
    'DISPID_SWFEExtraData', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechRecoResultTimes', 'ISpNotifySink', 'SPVOICESTATUS',
    'ISpRecognizer', 'DISPID_SVEBookmark', 'SPWORDPRONUNCIATION',
    'SECFIgnoreCase', 'DISPID_SpeechMemoryStream', 'ISpLexicon',
    'DISPID_SpeechFileStream', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRSCurrentStreamPosition', 'SVF_None', 'SPLO_DYNAMIC',
    'SAFT48kHz8BitStereo', 'ISpDataKey', 'SAFT16kHz8BitStereo',
    'DISPID_SRGSetTextSelection', 'SpeechGrammarTagWildcard',
    'SREFalseRecognition', 'SPPHRASE', 'SLODynamic',
    'DISPID_SOTSetId', 'DISPID_SRStatus', 'DISPID_SpeechVoiceStatus',
    'SPBO_AHEAD', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRGDictationLoad', 'SpCustomStream',
    'SAFT22kHz8BitStereo', 'SAFT44kHz8BitMono',
    'ISpeechLexiconPronunciations', 'SPSHORTCUTPAIRLIST',
    'SpeechAddRemoveWord', 'DISPID_SDKSetBinaryValue',
    'SRTExtendableParse', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCERecognizerStateChange', 'eLEXTYPE_PRIVATE3',
    'SP_VISEME_15', 'ISpEventSource', 'SRTStandard', 'SPXRO_SML',
    'DISPID_SpeechBaseStream', 'DISPID_SLWLangId',
    'ISpeechMemoryStream', 'DISPID_SGRName',
    'DISPID_SAFGetWaveFormatEx', 'SpeechPropertyResponseSpeed',
    'SPSNoun', 'DISPID_SMSGetData', 'DISPID_SRSClsidEngine',
    'SAFT12kHz8BitMono', 'SpeechCategoryAppLexicons',
    'SPPS_RESERVED1', 'DISPID_SRIsShared', 'SAFTADPCM_11kHzMono',
    'SAFTText', 'DISPID_SVDisplayUI', 'DISPID_SRSetPropertyString',
    'SGRSTTEpsilon', 'DISPID_SOTRemoveStorageFileName', 'SVP_14',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRSTPropertyName',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRGCommit',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPIDSPTSI_SelectionOffset',
    'SAFTCCITT_ALaw_8kHzMono', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SDKLLocalMachine', 'SVP_18', 'DISPID_SPEDisplayAttributes',
    'SPAO_NONE', 'SpMMAudioIn', 'SPPS_Function',
    'SAFT32kHz16BitStereo', 'STCInprocServer', 'SRERecoOtherContext',
    'SPSVerb', 'SDTRule', 'SPEI_END_INPUT_STREAM', 'SPSNotOverriden',
    'DISPID_SGRsCommit', 'SPDKL_CurrentUser', 'DISPID_SOTs_NewEnum',
    'SpeechAudioProperties', 'DISPID_SASFreeBufferSpace',
    'SPINTERFERENCE_NOISE', 'SVP_16', 'SECFIgnoreKanaType',
    'SAFTADPCM_11kHzStereo', 'STCRemoteServer',
    'ISpeechGrammarRuleStateTransition', 'SVP_19', 'SVP_8',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SMSADeviceId',
    'DISPID_SPRsCount', 'DISPID_SRCEEndStream', 'SVSFParseAutodetect',
    'SpeechPropertyComplexResponseSpeed', 'SPRECOCONTEXTSTATUS',
    'SPBOOKMARKOPTIONS', 'SPEI_VISEME', 'STCAll', 'SPPHRASEPROPERTY',
    'ISpEventSink', 'SAFTCCITT_uLaw_8kHzStereo', 'SPCS_DISABLED',
    'SPCS_ENABLED', 'STSF_CommonAppData', 'SPBO_PAUSE',
    'SPSMF_SAPI_PROPERTIES', 'SASStop',
    'DISPID_SRCCreateResultFromMemory', 'SPEI_RECOGNITION',
    'DISPID_SRCState', 'DISPID_SRGId', 'DISPID_SGRClear',
    'SAFT8kHz16BitStereo', 'SPRST_INACTIVE',
    'SWPKnownWordPronounceable', 'SAFTGSM610_11kHzMono', 'SWTDeleted',
    'SAFT32kHz16BitMono', 'DISPIDSPTSI', 'SREStreamEnd',
    'DISPID_SGRSTPropertyId', 'DISPID_SVEventInterests',
    'DISPID_SPRules_NewEnum', 'SVEViseme', 'DISPID_SRCERequestUI',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVEStreamEnd',
    'ISpNotifySource', 'DISPID_SVResume',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SGRsFindRule',
    'SASPause', 'DISPID_SRCVoicePurgeEvent', 'ISpObjectToken',
    'DISPID_SRGRules', 'DISPID_SRRTLength', 'SITooSlow',
    'DISPID_SVSLastBookmarkId', 'eLEXTYPE_PRIVATE7', 'SP_VISEME_5',
    'SPSTREAMFORMATTYPE', 'SpInprocRecognizer', 'SPEI_INTERFERENCE',
    'SPAUDIOBUFFERINFO', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPIGetText',
    'DISPID_SPPName', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPSHORTCUTTYPE', 'SAFT22kHz8BitMono', 'IInternetSecurityManager',
    'SAFT16kHz16BitStereo', 'SWTAdded', 'DISPID_SpeechObjectTokens',
    'SVP_2', 'SpeechMicTraining', 'ISpeechRecoResult',
    'DISPID_SpeechPhraseBuilder', 'SpMMAudioEnum',
    'DISPID_SVSInputWordLength', 'SDTLexicalForm',
    'SAFTADPCM_8kHzMono', 'DISPID_SVSLastResult', 'SpeechVisemeType',
    'DISPID_SVSyncronousSpeakTimeout', 'SPFM_OPEN_READWRITE',
    'SVSFParseSsml', 'SVP_17', 'ISpProperties',
    'SPINTERFERENCE_TOOSLOW', 'SpMemoryStream', 'ISpeechCustomStream',
    'SDTProperty', 'DISPID_SRCBookmark', 'DISPID_SRGRecoContext',
    'eLEXTYPE_PRIVATE20', 'SP_VISEME_0', 'SGRSTTTextBuffer',
    'DISPID_SPIGrammarId', 'DISPID_SRProfile',
    'SpeechRecognitionType', 'eWORDTYPE_ADDED', 'SREAdaptation',
    'Speech_StreamPos_Asap', 'SRAExport', 'SpNullPhoneConverter',
    'DISPID_SVWaitUntilDone', 'eLEXTYPE_USER_SHORTCUT', 'SRTReSent',
    'DISPID_SpeechPhraseProperties', 'DISPID_SpeechRecoContextEvents',
    'ISpeechObjectTokens', 'SAFTCCITT_uLaw_11kHzStereo', 'SRARoot',
    'SPAR_Unknown', 'SWPUnknownWordPronounceable',
    'DISPID_SPPConfidence', 'SAFT48kHz16BitMono',
    'DISPID_SRGCmdSetRuleIdState', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechRecoResult2', 'SPEI_START_SR_STREAM',
    'SPRECORESULTTIMES', 'SVSFDefault', 'SPLO_STATIC', 'SRADynamic',
    'DISPID_SAFGuid', 'DISPID_SPIRetainedSizeBytes',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechGrammarTagDictation',
    'DISPID_SRRAudio', 'SpeechCategoryAudioOut', 'SP_VISEME_9',
    'SP_VISEME_20', 'eLEXTYPE_PRIVATE2', 'DISPID_SRCPause',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCreateRecoContext', 'SpSharedRecoContext',
    'SAFT8kHz16BitMono', 'SVP_21', 'DISPID_SOTId',
    'DISPID_SRGDictationSetState', 'DISPID_SPIReplacements',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SOTGetStorageFileName',
    'ISpeechBaseStream', 'DISPID_SOTCreateInstance', 'DISPID_SVEWord',
    'DISPID_SOTRemove', 'SPCT_DICTATION', 'SPSHORTCUTPAIR',
    'DISPID_SASNonBlockingIO', 'DISPID_SCSBaseStream',
    'DISPID_SVStatus', 'Speech_Default_Weight',
    'DISPID_SLWPronunciations', 'DISPID_SOTCId', 'SpFileStream',
    'SPINTERFERENCE_TOOLOUD', 'SREAllEvents',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRGetPropertyNumber',
    'SPFILEMODE', 'ISpRecoContext2', 'SGDisplay',
    'SAFTADPCM_22kHzStereo', 'SpVoice', 'DISPID_SpeechGrammarRules',
    'eLEXTYPE_APP', 'SPWF_SRENGINE', 'SVEEndInputStream', 'SLOStatic',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPIAudioStreamPosition',
    'SITooQuiet', 'SREPropertyNumChange', 'DISPID_SpeechPhraseRule',
    'DISPID_SPRFirstElement', 'DISPID_SRRPhraseInfo'
]

_check_version('1.2.0', 1700094908.106081)
