...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\PYTHON_\PROJECT_PYTHON_\otherPY\GS_Vet_Clinic\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\PYTHON_\PROJECT_PYTHON_\otherPY\GS_Vet_Clinic\venv\Scripts\deactivate.nu'
